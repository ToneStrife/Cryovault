            ...
            <div ref={searchRef} className="relative">
              <div className="relative">
                ...
                <input
                  ...
                  className="pl-9 pr-8 py-2 w-72 bg-white border border-gray-200 rounded-lg text-sm text-gray-900 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent shadow-sm"
                />
                {quickSearch && (
